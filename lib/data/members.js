...
export const membersByCountry = [
  {
    ...
    members: [
      ...
      memberFromFile("albania", "Aleanca.png", {
        ...
        description: [
          "Alliance Against Discrimination of LGBTI (Aleanca) is a national civil society organization working to empower LGBTI people in Albania and to advance equality, non-discrimination and access to justice. Through direct service provision, strategic litigation, advocacy and institutional lobbying, Aleanca promotes legal recognition and policy reforms in line with European and international human rights standards.",
          "By combining community - based support with research, monitoring and professional capacity- building, the organization challenges stigma and discrimination and contributes to a fairer, safer and more inclusive society.",
        ],
        social: {
      ...
      memberFromFile("albania", "Streha.png", {
        ...
        description: [
          "Streha is a leading LGBTI+ organization in Albania dedicated to advancing the protection, empowerment, and social and economic inclusion of at-risk LGBTI+ youth.",
          "Through shelter-based interventions, institutional capacity building, and policy advocacy, Streha reduces exposure to violence and homelessness, strengthens access to rights and services, and improves pathways toward education, employment, and independent living. Working in Tirana and across the Albanian-speaking region, Streha contributes to sustainable, rights-based change by translating individual protection into systemic improvements in policies, practices, and public awareness.",
        ],
        social: {
  ...
  },
  {
    ...
    members: [
      ...
      memberFromFile("bih", "TOC.png", {
        ...
        description: [
          "Tuzla Open Center (TOC) is a civil society organization based in Tuzla, Bosnia and Herzegovina, dedicated to advancing human rights, equality, and democratic participation.",
      ...
      memberFromFile("bih", "Wings of Hope.png", {
        ...
        description: [
          "Foundation Wings of Hope is a Sarajevo-based organization providing psychosocial support and empowerment programs for marginalized communities.",
          "In April 2024, we opened the first LGBTIQ+ Safe House in Bosnia and Herzegovina, offering safe accommodation, basic living needs, psychosocial support, and trauma - informed care to survivors of violence and those at risk.",
        ],
        social: {
  ...
  },
  {
    ...
    members: [
      ...
      memberFromFile("croatia", "kolekTIRV.png", {
        name: "kolekTIRV",
        description: [
          "kolekTIRV is a prominent trans-led organization in Croatia dedicated to the protection and empowerment of trans, intersex, and gender-variant individuals through peer support, systemic advocacy, and professional education.",
          "By bridging the gap between the community and institutional frameworks, we work to ensure legal rights, accessible healthcare, and a society that fosters safety and self-determination for all gender identities.",
        ],
        social: {
      ...
      memberFromFile("croatia", "TMB.png", {
        ...
        description: [
          "Trans Network Balkan (TMB) is a regional organization founded in 2014 with the aim of building a strong TIRV (trans, intersex, and gender-variant) community and its allies across the Balkans. Since its establishment, TMB has connected eight countries: Albania, Bosnia and Herzegovina, Montenegro, Croatia, Kosovo, North Macedonia, Serbia, and Slovenia.",
          "TMB is part of a broad front of resistance - anti-fascist, feminist, and decolonial - and supports the united dismantling of systems of oppression and exploitation. With this goal, TMB stands shoulder to shoulder with local communities, organizations, and individuals.",
        ],
        social: {
      ...
      memberFromFile("croatia", "ZagrebPride.png", {
        description: [
          "Zagreb Pride is a civil society organization dedicated to advancing the rights, visibility, and well-being of LGBTIQ people in Croatia through public advocacy, community support, and cultural activism.",
          "We organize the annual Zagreb Pride March, run public awareness initiatives, and provide direct support through Rozi megafon, which offers legal counsel, psychosocial support, and peer-to-peer assistance. Our work promotes equality, inclusion, and social change across Croatian society.",
        ],
        social: {
  ...
  },
  {
    ...
    members: [
      memberFromFile("kosovo", "CEL Kosova.png", {
        description: [
          "CEL Kosova is a human rights organization working to promote equality and protect the rights of LGBTIQ+ persons in Kosovo.",
          "Through advocacy, capacity building, and direct legal and psychological support, the organization addresses discrimination, violence, and barriers to social and economic inclusion. CEL Kosova works with communities and institutions to contribute to a more inclusive and rights-based society.",
        ],
        social: {
      ...
      memberFromFile("kosovo", "CSGD.png", {
        description: [
          "The Center for Social Group Development (CSGD) is a Kosovo-based civil society organization working to advance human rights, LGBTIQ+ rights, social inclusion, and equality, with a particular focus on LGBTIQ+ communities.",
          "Since its establishment, CSGD has combined advocacy, community empowerment, research, and service provision to address discrimination, promote health and wellbeing, and strengthen institutional accountability.",
        ],
        social: {
  ...
  },
  {
    ...
    members: [
      ...
      memberFromFile("macedonia", "HERA.png", {
        description: [
          "HERA - Health Education and Research Association, founded in 2000, is a civil society organization dedicated to advancing health and social policies in North Macedonia.",
          "HERA works to ensure equal access to health services and information for all, with a focus on young people, women, Roma communities, and other vulnerable groups, through education, advocacy, and direct health and psychosocial services.",
        ],
        social: {
      ...
      memberFromFile("macedonia", "Helsinki Committee.png", {
        ...
        description: [
          "The Helsinki Committee for Human Rights - Skopje works to protect human rights, promote equality, and combat discrimination through legal aid, monitoring, advocacy, and public engagement.",
          "The organization has a strong focus on supporting marginalized groups, including LGBTQI+ persons, and advancing accountability, rule of law, and social justice.",
        ],
        social: {
      ...
      memberFromFile("macedonia", "KoalicijaMargini.png", {
        ...
        description: [
          "Coalition Margins is a civil society organization in North Macedonia working to advance the human, sexual, and health rights of marginalized communities.",
          "Through advocacy, research, community engagement, and strategic partnerships, the Coalition promotes equality, non-discrimination, and inclusive public policies, with a strong focus on LGBTI people, sex workers, people who use drugs, people living with HIV, and marginalized women.",
        ],
        social: {
      ...
      memberFromFile("macedonia", "LGBTI Jadro Strumica.png", {
        name: "LGBTI Jadro",
        description: [
          "LGBTI Jadro (Jadro means Core) is a local multi-ethnic organisation and community based in Strumica, North Macedonia, working to protect rights, empower, and provide support to the local queer population.",
          "The organisation’s activities focus on creating a safe space and advocating for equality in the country’s southeastern region. Established as one of the key initiatives outside the capital of North Macedonia, the organisation works to combat hate speech, support victims of discrimination, and promote social inclusion.",
          "Although North Macedonia has anti-discrimination legislation that protects sexual orientation, the local climate and social attitudes in Balkan towns such as Strumica can remain challenging due to traditional views and religious influences.",
        ],
        social: {
          facebook: "https://www.facebook.com/lgbtijadro/?locale=mk_MK",
        },
      }),
      ...
      memberFromFile("macedonia", "LGBTISupportCentre.png", {
        ...
        description: [
          "The LGBTI Support Centre was founded in 2012 as a subsidiary of the Helsinki Committee for Human Rights – Skopje, in response to the need for safe, community-based support and advocacy for LGBTI people in North Macedonia.",
          "Our vision is a society free from discrimination where all people enjoy universal human rights and freedoms, regardless of sexual orientation, gender identity, or any other trait.",
          "Our mission is to strengthen the LGBTI community for self-advocacy and to advance the social and legal status of LGBTI people in the Republic of North Macedonia through direct support services, community programming, and strategic advocacy.",
        ],
        social: {
      ...
      memberFromFile("macedonia", "LGBT United.png", {
        name: "LGBTI United",
        description: [
          "LGBTI United is a non-governmental, non-profit and multi-ethnic organisation based in Tetovo, North Macedonia, bringing together people of diverse sexual orientations, gender identities and gender expressions.",
          "The organisation works to protect, promote and advance the human rights and freedoms of LGBTI+ people, with a focus on equality, inclusion and access to essential health, social and legal services.",
          "Through advocacy, community strengthening, public awareness raising and direct support, LGBTI United contributes to creating a more supportive and inclusive environment for LGBTI+ people across North Macedonia. Its work also includes combating discrimination based on sexual orientation and gender identity, advocating for improved national legislation, supporting community spaces and activities, and promoting the sexual health of LGBTI+ people through HIV/AIDS and STI prevention programmes.",
        ],
        social: {
          website: "https://lgbtiunited.mk",
          linkedin: "https://www.linkedin.com/in/lgbt-united-tetovo/",
        },
      }),
      memberFromFile("macedonia", "LezFem.jpg", {
        name: "LezFem",
        description: [
          "LezFem is a lesbian-feminist group that creates space for connection, reflection, and collective action among women and lesbians in North Macedonia.",
          "Grounded in lived experience, the group works to amplify feminist voices and challenge inequality.",
        ],
        social: {
      ...
      memberFromFile("macedonia", "QueerCenterSkopje.png", {
        ...
        description: [
          "Skopje Queer Center offers free psychosocial and legal support for LGBTI+ individuals.",
          "The organization is engaged in research, evidence gathering, community strengthening, advocacy, and policy influence to advance human rights for the LGBTI+ community in North Macedonia.",
        ],
        social: {
      ...
      memberFromFile("macedonia", "STAR.png", {
        ...
        description: [
          "The Association for Support of Marginalized Workers STAR-STAR Skopje was founded in 2010 and is in actual fact a form of self-organized sex workers’ community in the Balkans and is one of a kind in the Republic of North Macedonia.",
          "Recognized as STAR – The First Sex Workers Collective in the Balkans, for more than 10 years STAR-STAR’s goal is to advocate for and promote sex workers’ rights within the state social, healthcare and legal system.",
        ],
        social: {
      ...
      memberFromFile("macedonia", "WomensAlliance.png", {
        ...
        description: [
          "Women’s Alliance is the first lesbian and feminist NGO dedicated to promoting and protecting the human rights of the LGBTI+ community in North Macedonia, guided by the principles of equality, diversity, and non-discrimination.",
          "The organization works to combat hate speech, violence, and discrimination based on sexual orientation, gender identity, and gender expression, while advocating for legal reforms and greater social inclusion of LGBTI+ people.",
        ],
        social: {
  ...
  },
  {
    ...
    members: [
      memberFromFile("montenegro", "CeMi.png", {
        ...
        description: [
          "Centre for Monitoring and Research (CeMI) is an independent, non-partisan, non-profit organization founded in Montenegro in 2000, dedicated to strengthening democracy, the rule of law, and institutional integrity.",
          "Through election observation, public policy research, and advocacy in the areas of electoral reform, judicial reform, anti-corruption, human rights and social cohesion, CeMI transforms research and monitoring into concrete recommendations that support democratic reforms and accountable institutions.",
          "CeMI is a leading election observation organization in Montenegro and an active member of international and regional networks, cooperating closely with domestic institutions, civil society, and international partners.",
        ],
        social: {
      ...
      memberFromFile("montenegro", "QueerMontenegro.png", {
        description: [
          "Queer Montenegro is a grassroot and feminist organization dedicated to promoting and protecting the human rights of LGBTIQ+ persons in Montenegro.",
          "Through advocacy, education, public events, and direct support services, we work to increase visibility, strengthen community resilience, and advance social and legal equality.",
        ],
        social: {
      ...
      memberFromFile("montenegro", "Spektra.png", {
        ...
        description: [
          "Association Spectra is a feminist NGO established in 2017 in Podgorica, Montenegro, dedicated to supporting the transgender, gender-diverse, and intersex (TIGV) community.",
          "Our mission is to promote gender equality, human rights, and social acceptance for LGBTIQ+ individuals through advocacy, support services, and specialized healthcare access. We also work to raise public awareness and educate institutions and media on the safety and protection of the TIGV community.",
        ],
        social: {
      ...
      memberFromFile("montenegro", "Stana.png", {
        name: "Association of LBTIQ Women STANA",
        description: [
          "Montenegrin LBTQ women association Stana is an LBTQ women’s association based in Montenegro, working to increase the visibility, equality and protection of lesbian, bisexual, trans and queer women.",
          "The organisation was established from the need to make LBTQ women more visible within both society and the wider LGBTIQ movement, growing out of the informal group kvirA with the support of Queer Montenegro and NGO Juventas.",
        ...
        social: {
          website: "https://www.asocijacijaspektra.org/",
          instagram: "https://www.instagram.com/udruzenje_stana/",
          facebook: "https://www.facebook.com/udruzenje.stana/",
        },
      }),
    ],
  },
  {
    ...
    members: [
      memberFromFile("serbia", "CRPC.png", {
        ...
        description: [
          "The Crisis Response and Policy Centre (CRPC) is a Belgrade-based civil society organization dedicated to protecting human rights and fostering social inclusion for refugees, asylum seekers, LGBTQIA+ persons, and other vulnerable groups.",
          "Through direct support, advocacy, education, and community engagement, CRPC promotes equality, dialogue, and inclusive practices across Serbia and the region.",
        ],
        social: {
      ...
      memberFromFile("serbia", "Crvena linija.png", {
        name: "Red Line",
        description: [
          "Crvena linija is a non-govermental organization working with young people, people living with HIV, and same-sex–oriented persons to promote health, human rights, and empowerment.",
          "Through its NS CheckPoint Center, it provides free and anonymous HIV and Hepatitis testing, counseling, and education, in close cooperation with health institutions and civil society partners.",
        ],
        social: {
      ...
      memberFromFile("serbia", "Da se zna.png", {
        ...
        description: [
          "Association Da se zna! is a civil society organization in Serbia dedicated to mapping and documenting hate-motivated incidents against LGBT+ persons, as well as providing legal and psychological support to survivors of such incidents.",
          "In addition, Da se zna! implements educational programs aimed at both the queer community and the general public, and works consistently to advocate for improved access to justice and stronger institutional protection of LGBT+ people.",
        ],
        social: {
      ...
      memberFromFile("serbia", "EGAL.png", {
        description: [
          "Egal is an organization dedicated to providing support, protection, and empowerment to LGBTIQ+ persons who have experienced violence and discrimination.",
          "The organization works closely with the community to offer psychosocial support and advocacy, while also promoting equality, solidarity, and social inclusion through community-based initiatives.",
        ],
        social: {
      ...
      memberFromFile("serbia", "FemSlam.png", {
        name: "FemSlam",
        description: [
          "FemSlam is an informal football initiative empowering LBTQ women through sport.",
          "As a women’s* football team and collective, it explores the intersections of gender, sport, and LGBTIQ issues through creative and activist approaches.",
        ],
        social: {
      ...
      memberFromFile("serbia", "Izađi.png", {
        name: "Group COME OUT",
        description: [
          "The Group COME OUT is an organization dedicated to supporting LGBTI+ people, with a primary focus on youth, their families, close social circles, and professionals working with youth.",
          "Since its founding in 2010, formal registration in 2013, and the opening of its first community center in 2018, the organization has developed four core program areas: work with LGBTI + youth, psychological counseling, education for inclusion and work with LGBTI + adults.",
          "Today, Group 'COME OUT' operates its own community center open from Wednesday to Saturday from 5PM till 10 PM and runs a psychological counseling service for LGBTI + youth supported by 35 volunteer counselors, for now.",
        ],
        social: {
      ...
      memberFromFile("serbia", "Labris.png", {
        ...
        description: [
          "Labris is a lesbian feminist non-profit civil society organization, founded with the aim of promoting lesbian human rights and lesbian visibility in society.",
      ...
      memberFromFile("serbia", "Potent.png", {
        ...
        description: [
          "Potent is a Serbian NGO working to advance sexual and reproductive health and HIV prevention through community-based services, education, and advocacy.",
          "The organization focuses on improving access to testing, prevention tools, and stigma-free healthcare for LGBTQI+ people and other marginalized communities.",
        ],
        social: {
      ...
      memberFromFile("serbia", "Praxis.png", {
        ...
        description: [
          ...
          "Through its work in the fields of status and socioeconomic rights, anti-discrimination, gender equality, migration, and child rights, Praxis empowers individuals and strengthens civil society.",
        ],
        social: {
      ...
      memberFromFile("serbia", "PRIMUS.png", {
        description: [
          "PRIMUS's core mission is the promotion of human rights, health care, and social services for LGBTIQ+ people, and multiple vulnerable populations including people living with HIV/AIDS, users of psychoactive substances, and sex workers.",
          "This is achieved through reducing violence and discrimination and providing education and support.",
        ],
        social: {
      ...
      memberFromFile("serbia", "RainbowIgnite.png", {
        name: "Rainbow Ignite",
        description: [
          "Rainbow Ignite is a civil society organization based in Serbia that empowers LGBTIQ+ communities through advocacy, research, education, cultural initiatives, and community-led action.",
          "We work to strengthen political participation, economic inclusion, gender equality, and the preservation of queer history, advancing a more just, inclusive, and equitable society.",
        ],
        social: {
      ...
      memberFromFile("serbia", "RromnjakoIlo.png", {
        name: "Rromnjako Ilo",
        description: [
          "We brake sexual taboos among Roma women and supports them to come out and accept their sexuality and identities.",
          "We build their resilience to exclusion, discrimination and violence to fullfill the mission: Roma women of different sexual orientation and identities are recognized in the community and the society.",
        ],
        social: {
      ...
      memberFromFile("serbia", "TalasTIRV.png", {
        description: [
          "Kolektiv Talas TIRV (eng. Collective Wave TIGV) started as an informal group in mid-2020, and we have been formally registered since July 2021. We are the only trans-led organization in Serbia.",
          "Our mission is to build a strong, organized, empowered, and inclusive TIGV community in Serbia because we firmly believe that only a movement that is rooted in the community can sustainably provide psychological, social, legal, economic, and educational support to its members, as well as successfully fight and resist the growing transphobia.",
          "We are addressing the problems of the TIGV community using a broader intersectional-feminist approach and by applying mechanisms that protect gender equality, and respect different identities and their freedom of expression.",
        ],
        social: {
      ...
      memberFromFile("serbia", "XY Spectrum.png", {
        description: [
          "XY Spectrum was founded in 2017 in Belgrade.",
          "It is committed to promote the rights of intersex and trans people and their families, improving their position and quality of life.",
        ],
        social: {
  ...
  },
  {
    ...
    members: [
      memberFromFile("slovenia", "DrustvoDIH.png", {
        ...
        description: [
          "DIH – Equal Under the Rainbow is a Slovenian non-profit organisation working to empower queer individuals and communities through advocacy, education, community-based programmes, and the promotion of safe sex practices.",
          "We promote equality, inclusion, and well-being across generations by creating safe spaces, strengthening visibility, and advancing queer rights at local, national, and European levels.",
        ],
        social: {
      ...
      memberFromFile("slovenia", "LEGEBITRA.png", {
        ...
        description: [
          "By continuously providing accessible, confidential and professional services, we provide support and empowerment for individuals, LGBT community, and people with HIV.",
          "Through advocacy, we contribute to improving legal protection, to increasing the visibility of LGBT people and understanding the position of people with HIV. By raising awareness of the general and professional public, we contribute to changing of attitudes towards our target groups.",
          "With all our activities, we are building a society where every identity is legitimate.",
        ],
        social: {
      ...
      memberFromFile("slovenia", "Moja Mavrica.png", {
        ...
        description: [
          ...
          "We operate on the principles of social work and regularly collaborate with the University of Ljubljana as well as civil society organisations from Slovenia and abroad.",
          "Through our comprehensive approach (combining direct community engagement, educational initiatives, research, and advocacy) we provide a structured, supportive, and evidence-based environment that promotes the resilience and mental well-being of our target groups.",
        ],
        social: {
      ...
      memberFromFile("slovenia", "SkucLL.jpg", {
        ...
        description: [
          "ŠKUC LL is the only lesbian organization in Slovenia and one of the oldest in Europe, founded in 1987.",
          "A grassroots NGO, it advances lesbian, feminist, and queer politics through cultural production, activism, publishing, media, and community spaces, playing a key role in shaping LGBTIQ culture, visibility, and rights in Slovenia.",
        ],
        social: {
      ...
      memberFromFile("slovenia", "SkucMagnus.png", {
        name: "ŠKUC Magnus",
        description: [
          "MAGNUS is a gay section at ŠKUC (Students Cultural Centre). It was founded in 1984 as the Cultural Organisation for Socialisation of Homosexuality.",
          "Its first and most important roles were organising the MAGNUS Festival with a wide variety of activities to make an acceptable homosexual lifestyle.",
        ],
        social: {
      ...
      memberFromFile("slovenia", "TransAkcija.png", {
        ...
        description: [
          "Transfeminist Initiative TransAkcija is a non-governmental organization that works to support trans+ people in Slovenia. The organization is based in Ljubljana.",
          "In addition to its monthly activities, TransAkcija also offers support services for trans+ and gender-diverse people, and educational programs for professionals.",
          "TransAkcija also strives for systemic changes in the field of human rights for trans+ and gender-diverse people in Slovenia, with an emphasis on regulating legal gender recognition and ensuring adequate healthcare.",
        ],
        social: {
  ...
  },
  {
    ...
    members: [
      memberFromFile("turkey", "7 Renk.png", {
        name: "Mersin 7Renk LGBTI+ Association",
        description: [
          "Mersin 7Renk is a community-based LGBTI+ organisation from Türkiye, working to advance equality, dignity and human rights for LGBTI+ people in the Mediterranean region. Founded through local LGBTI+ and trans-led activism, Mersin 7Renk has played an important role in building visibility, solidarity and community support beyond Türkiye’s largest urban centres.",
          "The organisation works through advocacy, education, research, documentation of human rights violations, community organising and public awareness-raising. Its work is particularly significant in addressing discrimination, hate speech, violence and institutional neglect affecting LGBTI+ people, with a strong focus on the lived realities and safety of trans people.",
          "Through its local presence and rights-based approach, Mersin 7Renk contributes to strengthening the LGBTI+ movement in Türkiye and to amplifying voices that are often pushed to the margins.",
        ],
        social: {
          website: "http://www.mersinyedirenk.org",
      ...
      memberFromFile("turkey", "Genc.png", {
        ...
        description: [
          "Young Lesbian Gay Bisexual Trans Intersex Youth Studies and Solidarity Association (short name Young LGBTI+ Association) was established in İzmir in 2016 with the aim of researching the problems of LGBTI+ youth, bringing these problems to the agenda, offering solutions and opening spaces for LGBTI+ youth to express themselves.",
          "Works for the right to access basic needs such as shelter, education and health, youth rights, sexual rights, social activities, rights advocacy, fight against hate crimes and peer support define the basic field of activity of the association.",
          "Although LGBTI+ Youth constitute the primary working area of the association, issues related to the LGBTI+ movement are also included in its working area, and people of all age groups can take part in the activities of the association and benefit from the services of the association.",
        ],
        social: {
      ...
      memberFromFile("turkey", "HEVİ LGBTİ.png", {
        ...
        description: [
          "Our mission is to defend the right to life and the human rights of minority, Kurdish, and refugee LGBTIQ+ persons and to advocate for their equal and fair access to social rights. We focus on addressing the intersecting issues of class, ethnicity, sexism, migrant and refugee rights, and broader freedoms.",
          "HEVI is a self-organization that emerged from the grassroots, bringing together diverse LGBTIQ+ voices—Kurdish, Armenian, Arab, Turkish, Roma, Alevi, Christian, and many more—and producing policies that address their unique needs and experiences.",
        ],
        social: {
      ...
      memberFromFile("turkey", "Istanbul Pride.png", {
        description: [
          "Istanbul Pride is a volunteer-led collective organizing Pride Week and the Pride March in Türkiye. Since 2015, despite bans, detentions, and increasing state pressure, Istanbul Pride has continued to organize peacefully, asserting the right to assembly and visibility for LGBTI+ communities.",
          "Through Pride Week events and the annual march, Istanbul Pride creates spaces for resistance, solidarity, joy, and collective care.",
        ],
        social: {
      ...
      memberFromFile("turkey", "İnter Dayanışma.png", {
        ...
        description: [
          "İnter Dayanışma is the primary advocacy organization in Turkey dedicated to the human rights and bodily integrity of intersex individuals.",
          "The organization works to end non-consensual medical interventions on intersex children while providing peer support, legal advocacy, and educational resources to increase intersex visibility and social acceptance. Through community empowerment and policy reform, they strive to ensure a life of dignity and self-determination for all intersex people.",
        ],
        social: {
      ...
      memberFromFile("turkey", "Kaos.png", {
        name: "Kaos GL",
        description: [
          "Kaos GL works with the slogan of “LGBTI+ (lesbian, gay, bisexual, trans, intersex and other identities) rights are fundamental human rights” and develops policies accordingly.",
          "By reporting and doing advocacy particularly in the field of hate crimes and anti-discrimination law to eliminate discrimination against LGBTI+s, to prevent human rights violations and to promote equality.",
        ],
        social: {
      ...
      memberFromFile("turkey", "Lambdaistanbul.png", {
        name: "Lambdaistanbul LGBTI+ Solidarity Association",
        description: [
          "Lambdaistanbul LGBTI+ Solidarity Association, founded in 1993, is a horizontally organized and volunteer based association that aims to empower the LGBTI+ community.",
          "Primary aim of Lambdaistanbul is to maintain Lambda Cultural Center; a safe space hosting numerous events for LGBTI+ people to join.",
        ],
        social: {
          website: "https://www.lambdaistanbul.org",
          instagram: "https://www.instagram.com/lambdaistanbul",
          facebook: "https://www.facebook.com/lambdaistanbul.lgbti/",
          twitter: "https://x.com/lambda_istanbul",
          youtube: "https://www.youtube.com/channel/UCvDbCziEM2vV9K0LrD6P22A",
        },
      }),
      memberFromFile("turkey", "Listag.png", {
        ...
        description: [
          "LISTAG (LGBTI+ Families and Allies Association) is a civil society organization in Türkiye founded by families and relatives of LGBTI+ individuals.",
          "The association aims to strengthen social acceptance and contribute to the realization of equal citizenship rights through family-based support mechanisms, advocacy, and awareness-raising activities. It works to combat discrimination based on sexual orientation, gender identity, and sex characteristics.",
        ],
        social: {
      ...
      memberFromFile("turkey", "Muamma.png", {
        ...
        description: [
          "Muamma LGBTI+ Association is a community-based organization working to protect and support the rights, well-being, and resilience of LGBTI+ individuals in Turkey.",
          "The association provides psychosocial and peer support, combats discrimination, and strengthens community solidarity. The association focuses particularly on trans+ individuals and those facing intersecting vulnerabilities.",
        ],
        social: {
      ...
      memberFromFile("turkey", "PembeHayat.png", {
        ...
        description: [
          "Pink Life LGBTI+ Solidarity Association is Türkiye’s first trans rights and trans-led organisation, founded in 2006. Pink Life exists to combat discrimination, hate crimes, violence, and social exclusion targeting LGBTI+ people with a special focus on trans identities.",
          "Its mission is to defend trans rights through direct support, community building and advocacy, and to strengthen a movement rooted in solidarity, resilience and collective care.",
        ],
        social: {
      ...
      memberFromFile("turkey", "RedUmbrella.png", {
        ...
        description: [
          "Red Umbrella Sexual Health and Human Rights Association is a rights-based organization dedicated to advocating for the human rights and sexual health of sex workers in Türkiye.",
      ...
      memberFromFile("turkey", "SPoD.png", {
        ...
        description: [
          "Founded in 2011 with the dream of a fair, equal, and free world under the rainbow, SPoD provides legal, social, and psychological counseling to LGBTI+ people.",
          "In addition to running campaigns and following up cases, SPoD continues to train institutions and municipalities, mental health experts and lawyers. As SPoD, we have been conducting academic research, organizing seminars and panel discussions.",
          "We are working on election campaigns together with schools of politics and activism. We also organize advocacy meetings by forming support groups. SPoD has a dedicated network of professional staff, volunteers, and experts to carry out all these activities.",
        ],
        social: {
...
/**
 * Normalize member description (string or string[]) to paragraph list.
 */
export function getMemberDescriptionParagraphs(description) {
...
export function memberDescriptionToPlainText(description) {
  return getMemberDescriptionParagraphs(description).join(" ");
}
